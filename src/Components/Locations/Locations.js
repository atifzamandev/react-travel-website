...
import classes from "../Locations/Locations.module.scss";
import { IoLocationOutline } from "react-icons/io5";
import { BsArrowRight } from "react-icons/bs";

import BoraBoraJPG from "../../assets/borabora.jpg";
import MasdivesJPG from "../../assets/maldives.jpg";
...
const locationData = [
  ...
  { id: 2, location: "Maldives", isFeatured: true, img: MasdivesJPG },
  ...
  { id: 8, location: "Maldives", isFeatured: true, img: MasdivesJPG },
  { id: 9, location: "Cabo San Lucas", isFeatured: false, img: CaboSanLucasJPG},
];

const Locations = ({ page }) => {
  //    Discuss with Hamza about mapData
